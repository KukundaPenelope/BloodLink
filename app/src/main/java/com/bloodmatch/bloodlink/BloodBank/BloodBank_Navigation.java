...
public class BloodBank_Navigation extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {

    ActivityBloodBankNavigationBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityBloodBankNavigationBinding.inflate(getLayoutInflater());
